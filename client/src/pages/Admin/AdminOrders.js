            ...
            <div className="container-fluid m-3 p-3 dashboard">
                <div className='row'>
                    ...
                    <div className='col-md-9'>
                        ...
                        {
                            orders?.map((o, i) => {
                                return <div className='border shadow'>
                                    <table className='table'>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{i + 1}</td>
                                                <td>
                                                    <select className="form-select" onChange={(e) => handleChange(o._id, e.target.value)} defaultValue={o?.status} aria-label="Default select example">
                                                        {
                                                            status.map((s, i) =>
